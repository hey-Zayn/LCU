  ...
  return (
    <div className="bg-black">
      ...
      >
        <img
          ref={logoRef}
          src="/dev/images/forward_logo.svg"
          alt="Logo"
          className="absolute w-full top-1/4 -translate-y-1/2 h-40 z-20 filter brightness-0 invert"
        ...
        <img
          ...
          alt="Panda"
          className="absolute -top-4 w-[14%] h-[12%] max-sm:w-[14%] max-sm:h-[13%] max-sm:top-1 md:w-[12%] md:h-[18%] lg:w-[12%] lg:h-[18%] xl:w-[12%] xl:h-[18%]"
