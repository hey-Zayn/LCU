...
const SEOTpyes = [
  {
    ...
    dis: "Unlock your website's ranking potential with our expert keyword research and strategy services. Our SEO professionals conduct in-depth analysis of your industry and current keyword performance to identify high-value search terms that will drive targeted traffic and improve your search engine positions.",
  },
  {
    title: "Strategic Link Building for Authority & Ranking",
    dis: "Elevate your website's authority and achieve higher search engine rankings with our strategic link building services. We focus on acquiring quality backlinks from reputable and relevant websites, understanding that strong external links are a critical factor in SEO success.",
  },
  {
    title: "Comprehensive Technical SEO Optimization",
    dis: "Ensure your website's technical health is optimized for search engine crawlers and user experience. Our technical SEO services address crucial elements like site speed, mobile-friendliness, site architecture, and indexability to improve your website's ability to rank effectively.",
  },
  {
    title: "Localized SEO Strategies for Local Visibility",
    dis: "Connect with local customers actively searching for your business. Our local SEO strategies focus on optimizing your Google Business Profile (GBP), enhancing local citations, and managing your online reputation to increase your visibility within your target geographic area and attract high-intent local traffic.",
  },
  {
    title: "Effective On-Page SEO for Relevance & User Engagement",
    dis: "Improve your website's content and structure to align perfectly with target keywords and user search intent. Our on-page SEO services ensure that your website's elements are optimized to communicate relevance and value to both search engines and your audience, leading to improved rankings and user engagement.",
  },
  {
    title: "Strategic Off-Page SEO for Brand Building & Authority",
    dis: "Extend your online influence and build a strong brand presence with our strategic off-page SEO efforts. We focus on activities that enhance your website's reputation and visibility beyond your own site, establishing you as a trusted authority in your industry and improving overall search engine trust.",
  },
  {
    title: "Amazon SEO to Maximize Product Discovery & Sales",
    dis: "Increase the discoverability of your products on Amazon's vast marketplace and reach millions of potential buyers. Our specialized Amazon SEO services optimize your product listings to rank higher in Amazon searches, connecting you with customers actively looking for products like yours and driving increased sales.",
  },
  {
    title: "Data-Driven Conversion Rate Optimization (CRO)",
    dis: "Transform more website visitors into paying customers with our data-driven Conversion Rate Optimization (CRO) services. We analyze user behavior and implement strategic changes to your website to improve conversion rates, maximize your online revenue, and enhance customer lifetime value.",
  },
  {
...
const packages = [
  ...
  },
  {
    ...
    features: [
      { title: "Custom SEO Audit & Strategic Roadmap", detail: "Tailored audit and a bespoke SEO strategy aligned with your specific business objectives and long-term growth goals." },
      {
